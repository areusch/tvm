...
if(USE_STANDALONE_CRT)
  ...
  file(GLOB_RECURSE crt_srcs
       ...
       "${CMAKE_SOURCE_DIR}/src/runtime/crt/common/*.c" "${CMAKE_SOURCE_DIR}/src/runtime/crt/graph_runtime/*.c")

  message(STATUS "crt srcs " ${crt_srcs})
  ...
  message(STATUS verbose ${make_quiet})
  add_custom_command(
...
# add_library(host_standalone_crt STATIC IMPORTED)
# set_property(TARGET host_standalone_crt PROPERTY IMPORTED
# target_include_directories(standalone_crt PRIVATE "standalone_crt/include")

# function(tvm_crt_add_config_include library_name crt_config_h)
#   get_filename_component(${library_name}_crt_config_include_dir ${crt_config_h} NAME)

#   get_filename_component(${library_name}_crt_config_include_dir ${crt_config_h} DIRECTORY)
#   target_include_directories(${library_name} PRIVATE ${library_name}_crt_config_include_dir)
# endfunction(tvm_crt_add_config_include)

# function(tvm_crt_add_c_runtime_common library_name crt_config_h crt_root)
#   file(GLOB ${library_name}_SRCS ${crt_root}/common/*.c ${crt_root}/graph_runtime/*.c)
#   add_library(${library_name} STATIC ${library_name}_SRCS)
#   target_include_directories(${library_name} PRIVATE "include")
#   tvm_crt_add_config_include(${library_name} ${crt_config_h})
# endfunction(tvm_crt_add_c_runtime_common)

# function(tvm_crt_add_c_graph_runtime library_name crt_config_h crt_root)
#   file(GLOB ${library_name}_SRCS ${crt_root}/common/*.c ${crt_root}/graph_runtime/*.c)
#   add_library(${library_name} STATIC ${library_name}_SRCS)
#   target_include_directories(${library_name} PRIVATE "include")
#   tvm_crt_add_config_include(${library_name} ${crt_config_h})
# endfunction(tvm_crt_add_c_graph_runtime)
